...
export const categories = ["Tai nghe", "Loa", "Đồng hồ", "Tai nghe Earbuds", "Chuột", "Trang trí"];
...
export const ourSpecsData = [
    { title: "Miễn phí vận chuyển", description: "Tận hưởng giao hàng nhanh chóng, miễn phí cho mọi đơn hàng không điều kiện, giao tận cửa đáng tin cậy.", icon: SendIcon, accent: '#05DF72' },
    { title: "7 ngày đổi trả dễ dàng", description: "Thay đổi ý định? Đừng lo lắng. Trả lại bất kỳ mặt hàng nào trong vòng 7 ngày.", icon: ClockFadingIcon, accent: '#FF8904' },
    { title: "Hỗ trợ khách hàng 24/7", description: "Chúng tôi luôn ở đây vì bạn. Nhận trợ giúp chuyên nghiệp với đội ngũ hỗ trợ khách hàng của chúng tôi.", icon: HeadsetIcon, accent: '#A684FF' }
]
